...
function watchFactoryNameToDiagnostic(watchFactory: CompilerOptionsValue): [DiagnosticMessage] | undefined {
    Debug.assert(watchFactory === undefined || isString(watchFactory));
...
function watchFactoryToDiagnostic(watchFactory: CompilerOptionsValue, valueExpression: Expression | undefined) {
    Debug.assert(isString(watchFactory) || typeof watchFactory === "object");
    ...
    function convertPropertyValueToJson(valueExpression: Expression, option: CommandLineOption | undefined): any {
        ...
        switch (valueExpression.kind) {
            ...
            case SyntaxKind.StringLiteral:
                ...
                reportInvalidOptionValue(option && isString(option.type) && option.type !== "string" && option.type !== "string | object" && (option.type !== "listOrElement" || option.element.type !== "string"));
            ...
            case SyntaxKind.ObjectLiteralExpression:
                reportInvalidOptionValue(option && option.type !== "object" && option.type !== "string | object" && (option.type !== "listOrElement" || option.element.type !== "object"));
