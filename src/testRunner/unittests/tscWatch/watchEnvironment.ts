...
describe("unittests:: tsc-watch:: watchEnvironment:: tsc-watch with different polling/non polling options", () => {
    ...
    describe("watchFactory", () => {
        ...
        interface WatchFactorySystem extends TestServerHost {
            factoryData: {
        ...
        function createSystem(watchOptions?: ts.WatchOptions) {
            ...
            const system = createWatchedSystem([aTs, bTs, configFile, libFile], { currentDirectory: "/user/username/projects/myproject" }) as WatchFactorySystem;
            ...
            function serializeWatches(baseline: string[] = []) {
                ...
                serializeMultiMap(baseline, "WatchedFiles", watchedFiles);
                serializeMultiMap(baseline, "WatchedDirectories:Recursive", watchedDirectoriesRecursive);
                serializeMultiMap(baseline, "WatchedDirectories", watchedDirectories);
                return baseline;
            }
        }
